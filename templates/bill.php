...
<form method="POST" action="payment" enctype="multipart/form-data">
	...
	<input type="submit" name="submit" class="btn btn-large" style="width:100%;background-color:var(--website-color); color:var(--header-button-color)" value="<?php echo $proceedToPaymentText ?>">
</form>
</div>
