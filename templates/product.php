			...
			<div class="col-md-6">
				<div id="carouselExampleIndicators" class="carousel slide imglist" data-ride="carousel">
					<div class="carousel-inner flexslider">
						...
						<div class="carousel-item <?php echo $active ?>">
							<div class="img_producto_container" data-scale="1.6">
								<a class="dslc-lightbox-image img_producto" href="javascript:void();"  target="_self" style="background-image:url('<?php echo encryptImage("logos/{$images[$i]["imageurl"]}") ?>')"></a>
							</div>
					...
					<ol class="carousel-indicators row">
						...
						?>
						<li data-target="#carouselExampleIndicators" data-slide-to="<?php echo $i ?>" class="<?php echo $active . " " . $cust ?> col-3"><img class="d-block w-100" src="<?php echo encryptImage("logos/{$images[$i]["imageurl"]}") ?>" alt="<?php echo $i ?> slide"></li>
						<?php
					}
					?>
					</ol>
