			...
			<div class="col-1 text-center mt-3">
				<div id="menuToggle">
					...
					<ul id="menu">
						...
						echo (isset($aboutPrivacy) AND (!empty($aboutPrivacy[0]["enTerms"]) || !empty($aboutPrivacy[0]["arTerms"]))) ? "<li><a data-toggle='modal' data-target='#return_popup' aria-label='return'>".direction("Terms & Conditions","الشروط والأحكام")."</a></li>" : "";
						?>
