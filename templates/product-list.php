...
<div class="mb-3"></div>
<?php
if( $products = selectDB("products","`hidden` = '0' AND `id` != '{$product[0]["id"]}' AND `storeId` = '{$storeID}' ORDER BY RAND() LIMIT 4") ){ 
						...
						<td class="text-right">
							<div class="product-box" style="height: 100%;">
								...
								<div class="product-text">
									<label class="product-title txt-dark" style="height:50px;overflow-y:auto"><?php echo direction($products[$i]["enTitle"],$products[$i]["arTitle"]); ?></label>
