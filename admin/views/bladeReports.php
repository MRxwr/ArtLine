		...
		<div class="form-group">
			...
			<?php
				if( $stores = selectDB("stores", "`status` = '0' AND `hidden` = '0'") ){
					echo "<select name='storeId' class='form-control' style=''>";
...
$totalIntInvoices = 0;
	...
	<tr>
		...
		<td class="txt-dark"><a href="?v=Order&orderId=<?php echo $orderIds[$i]["id"] ?>" target="_blank"><?php echo $orderIds[$i]["orderId"] ?></a></td>
