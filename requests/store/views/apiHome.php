...
if( $categories = selectJoinDB("category_products",$joinData,"t1.status = '0' AND t1.hidden = '1' GROUP BY t.categoryId ORDER BY t1.enTitle") ){
...
if( $brands = selectJoinDB("products",$joinData,"t1.status = '0' AND t1.hidden = '1' AND t1.imageurl != '' GROUP BY t.brandId ORDER BY t1.enTitle") ){
